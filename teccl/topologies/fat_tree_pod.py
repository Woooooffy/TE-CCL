...
class FatTreePod(Topology):
    """
    Single pod of a fat-tree, 4 ports per switch.

        GPU_A0 --\\                          /-- GPU_B0
                  EdgeA --- Spine1, Spine2 --- EdgeB
        GPU_A1 --/                          \\-- GPU_B1

    Node indices: 0=GPU_A0, 1=GPU_A1, 2=GPU_B0, 3=GPU_B1,
                  4=EdgeA, 5=EdgeB, 6=Spine1, 7=Spine2
    """
    ...
    def construct_topology(self, topo_input: TopologyParams):
        ...
        edges = {
            ...
            (4, 6): (switch_link_capacity, switch_link_alpha),  # EdgeA - Spine1
            (4, 7): (switch_link_capacity, switch_link_alpha),  # EdgeA - Spine2
            (5, 6): (switch_link_capacity, switch_link_alpha),  # EdgeB - Spine1
            (5, 7): (switch_link_capacity, switch_link_alpha),  # EdgeB - Spine2
        }
